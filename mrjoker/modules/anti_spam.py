...
from mrjoker import (DEV_USERS, EVENT_LOGS, OWNER_ID, STRICT_GBAN, DRAGONS,
...
GBAN_GIF = "https://telegra.ph/file/448d9f9fb36dcaea0c702.mp4"
GBAN_PIC = "https://telegra.ph/file/e370be204f17591ee2e22.mp4"
GBAN_VID = "https://telegra.ph/file/60755f87169dbe7795626.mp4"
MIKU_PIC = "https://telegra.ph/file/d00b3e4492df986d97790.mp4"
MIKU_VID = "https://telegra.ph/file/8b12765d603bef51d66a4.mp4"
MIKU_ERROR_PIC = "https://telegra.ph/file/666da9923157be20aa441.mp4"
UNGBAN_GIF = "https://telegra.ph/file/533bed56a45c3b01c6267.mp4"
UNGBAN_PIC = "https://telegra.ph/file/ed79ae4a6decd9d3759b9.mp4"
UNGBAN_VID = "https://telegra.ph/file/c11ec7478e467a59dfe07.mp4"
...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_animation( GBAN_GIF, caption= "On it!")
        ...
        try:
            ...
            if excp.message in GBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    bot.send_animation(
                        EVENT_LOGS,
                        MIKU_ERROR_PIC, caption= f"Could not gban due to {excp.message}",
                        parse_mode=ParseMode.HTML)
                else:
    ...
    log_message = (
        f"╒═══「 #LethalEliminator 」\n"
        f"<b>• Generated From:</b> <code>{chat_origin}</code>\n"
        ...
        f"<b>• Chats Affected:</b> <code>{gbanned_chats}</code>")
    ...
    if EVENT_LOGS:
        try:
            log = bot.send_animation(
                EVENT_LOGS, GBAN_PIC, caption=log_message, reply_markup=InlineKeyboardMarkup(buttons),
                parse_mode=ParseMode.HTML,            
        )
        except BadRequest as excp:
            log = bot.send_animation(
                EVENT_LOGS, GBAN_PIC, caption=log_message +
    ...
    if gban_time > 60:
        ...
        message.reply_animation( GBAN_VID, caption= "Done! Gbanned.", parse_mode=ParseMode.HTML)
    else:
        message.reply_animation( GBAN_VID, caption= "Done! Gbanned", parse_mode=ParseMode.HTML)

    try:
        bot.send_animation(
            user_id, MIKU_PIC, caption ="#EVENT"
...
def ungban(update: Update, context: CallbackContext):
    ...
    message.reply_animation(
        UNGBAN_GIF, caption= f"I'll give {user_chat.first_name} a second chance, globally.")
    ...
    if EVENT_LOGS:
        try:
            log = bot.send_animation(
                EVENT_LOGS, UNGBAN_PIC, caption=log_message, parse_mode=ParseMode.HTML)
        except BadRequest as excp:
            log = bot.send_animation(
                EVENT_LOGS, UNGBAN_PIC, caption=log_message +
                "\n\nFormatting has been disabled due to an unexpected error.")
    else:
        send_to_list(bot, DRAGONS + DEMONS, log_message, html=True)
        ...
        try:
            ...
            if excp.message in UNGBAN_ERRORS:
                ...
                if EVENT_LOGS:
                    ...
                    bot.send_animation(
                        OWNER_ID, MIKU_VID, caption= f"Could not un-gban due to: {excp.message}")
                return
        except TelegramError:
            pass
    ...
    if ungban_time > 60:
        ...
        message.reply_animation(
            UNGBAN_GIF, caption = f"Person has been un-gbanned. Took {ungban_time} min")
    else:
        message.reply_text(
            UNGBAN_GIF, caption = f"Person has been un-gbanned. Took {ungban_time} sec")
...
def check_and_ban(update, user_id, should_message=True):
    ...
    if sql.is_user_gbanned(user_id):
        ...
        if should_message:
            ...
            update.effective_message.reply_animation( UNGBAN_VID, caption=text, parse_mode=ParseMode.HTML)
