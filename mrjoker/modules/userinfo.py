...
MIKU_IMG = "https://telegra.ph/file/96d2c937c6a31813627c2.jpg"
...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>g\Gєттιиg ιиfσ fяσм ★彡 𐒨χS ∂в 彡★...</code>", parse_mode=ParseMode.HTML)
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_photo(
            ...
            + "\n╘══「 By [• 🇮🇳 • †ʀ ƈɾαȥყ](https://t.me/DreamerNo1) 」\n",
            parse_mode=ParseMode.MARKDOWN,
