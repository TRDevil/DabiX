...
from mrjoker import pbot as app, BOT_ID
from mrjoker.utils.errors import capture_err
from mrjoker.utils.permissions import adminsOnly
from mrjoker.ex_plugins.dbfunctions import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
from mrjoker.utils.filter_groups import karma_negative_group, karma_positive_group
from mrjoker import arq

regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|pro|cool|good|DC|👍)$"
regex_downvote = r"^(\-|\-\-|\-1|👎|noob|weak|Looser)$"
