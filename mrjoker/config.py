...
from mrjoker import BOT_USERNAME, dp
from mrjoker.config import get_bool_key
from mrjoker.modules.error import parse_update
from mrjoker.utils.filters import ALL_FILTERS
...
for module_name in ALL_FILTERS:
    ...
    imported_module = import_module("mrjoker.utils.filters." + module_name)
